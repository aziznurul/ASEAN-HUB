            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route(Auth::user()->role . '.dashboard') }}">
                        <img src="{{ asset('asset/images/logo.png') }}" alt="Logo" class="block h-16 w-auto">
                    </a>
                </div>
                ...
                @if(Auth::user()->role === 'jury') <!-- Only show for jury users -->
                    <x-nav-link :href="route('jury.top10')" 
                                :active="request()->routeIs('jury.top10')">
                        {{ __('Top 10 Finalists') }}
                    </x-nav-link>
                    <x-nav-link :href="route('jury.top5')" 
                                :active="request()->routeIs('jury.top5')">
                        {{ __('Top 5 Finalists') }}
                    </x-nav-link>
                @endif
            </div>
